const scrapingUtils = {
	...
	getDomain: function getDomain (url, uriObj) {
		const secondLevelExtensions = ["com","net","co","gov","gob","gouv","gc","qc","edu","org","mil","io","biz","go","hub","business","ac","weebly","squarespace","blogspot","yolasite","wordpress","wixsite","wix","vpweb","ueniweb","webs","tripod","negocio","godaddysites","homestead","jimdo","us","edan"];
